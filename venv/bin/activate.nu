...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/edlang/PycharmProjects/IMDB_Score_Pred/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/edlang/PycharmProjects/IMDB_Score_Pred/venv/bin/deactivate.nu'
